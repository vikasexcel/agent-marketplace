...
const SocialLink = ({
  ...
  <a href={href} target="_blank" rel="noreferrer" className="group">
    ...
    <Icon className="h-5 w-5 fill-zinc-500 transition group-hover:fill-gray-100 dark:fill-zinc-400 dark:group-hover:fill-gray-200" />
  </a>
)

const MinimalSocialsFooter = () => {
  return (
    <footer className="border-t border-zinc-800/50 dark:border-white/10 text-gray-400 py-6 sm:py-8 mt-auto w-full">
      <div className="mx-auto flex max-w-7xl flex-col sm:flex-row items-center justify-between gap-4 px-4">
        ...
        <div className="flex gap-5">
          <SocialLink href="https://x.com/Paradoxical_xD" icon={XIcon}>
            Follow me on X
          </SocialLink>
          <SocialLink href="https://github.com/gautamkumar1/Template" icon={GitHubIcon}>
            Follow me on GitHub
          </SocialLink>
